 ...
 * leaves this file unscanned. The suite reproduces six shebang cases rather
 * than asserting the rule - five interpreters and the absence of one - because
 * two earlier wordings of this paragraph each stated a rule the auditor does
 * not have. The vendored predecessor had no shebang for the same reason.
 */
